...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nyan-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nyan-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nyan transaction") + "\n" +
              "  nyan-tx [options] -create [commands]   " + _("Create hex-encoded nyan transaction") + "\n" +
              "\n";
