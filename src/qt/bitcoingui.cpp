    ...
    platformStyle(_platformStyle)
{
    ...
    // NYAN: load fallback font in case Comic Sans is not available on the system
    ...
    // NYAN: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // NYAN: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&NYAN Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a NYAN address"));
    ...
    receiveCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/receiving_addresses"), tr("&NYAN Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nyan: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NYAN addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NYAN addresses"));
    ...
    openAction->setStatusTip(tr("Open a nyan: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible NYAN command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to NYAN network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("NYAN"); // default title
