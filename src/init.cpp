...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // NYAN 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/nyan/nyan>";
    const std::string URL_WEBSITE = "<https://nyan.com>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // NYAN: Do we need to do any RPC mining init here?
