...
const char * const BITCOIN_CONF_FILENAME = "nyan.conf";
const char * const BITCOIN_PID_FILENAME = "nyand.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NYAN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NYAN";
#else
    // Unix
    return pathRet / ".nyan";
#endif
