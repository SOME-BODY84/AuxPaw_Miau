NYAN Core version 1.14.3 is now available from:

  <https://github.com/nyan/nyan/releases/tag/v1.14.3/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/nyan/nyan/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/nyan/
  * @NYAN on Twitter for high priority announcements
  * @nyan\_devs on Twitter for updates on development work
...
NYAN Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
NYAN Core should also work on most other Unix-like systems but is not
...
Block download timeouts are expressed as a multiple of block interval, and as such NYAN block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Return unspents greater or equal than a specific amount in NYAN: minimumAmount (default = 0).
* Return unspents lower or equal than a specific amount in NYAN: maximumAmount (default=unlimited).
* Return unspents with a total number lower or equal than a specific number: maximumCount (default=0=unlimited).
* Return unspents which total is greater or equal than a specific amount in NYAN: minimumSumAmount (default=unlimited).
...
* Change IPC prefix from `bitcoin:` to `nyan:`.
